...
// @description    [jonatkins-2015-01-30-011720] Total conversion for the ingress intel map.
...
window.iitcBuildDate = '2015-01-30-011720';
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2015-01-30-011720');
...
var script = document.createElement('script');
var info = { buildName: 'jonatkins', dateTimeVersion: '20150130.11720' };
